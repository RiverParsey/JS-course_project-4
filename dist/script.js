...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.dropdown = function () {
  for (let i = 0; i < this.length; i++) {
    const id = (0,_core__WEBPACK_IMPORTED_MODULE_0__["default"])(this[i]).getAtt('id');
    (0,_core__WEBPACK_IMPORTED_MODULE_0__["default"])(this[i]).click(() => {
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.modal = function (created) {
  for (let i = 0; i < this.length; i++) {
    const target = (0,_core__WEBPACK_IMPORTED_MODULE_0__["default"])(this[i]).getAtt('data-target');
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.createModal = function ({
  ...
  for (let i = 0; i < this.length; i++) {
    ...
    modal.setAttribute('id', (0,_core__WEBPACK_IMPORTED_MODULE_0__["default"])(this[i]).getAtt('data-target').slice(1));
    ...
    (0,_core__WEBPACK_IMPORTED_MODULE_0__["default"])((0,_core__WEBPACK_IMPORTED_MODULE_0__["default"])(this[i]).getAtt('data-target')).fadeIn(500);
  }
};
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.getAllAtt = function (attributeName) {
  let result = {};
  for (let i = 0; i < this.length; i++) {
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.setAtt = function (attributeName, value) {
  for (let i = 0; i < this.length; i++) {
    this[i].setAttribute(attributeName, value);
  }
  return this;
};
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.removeAtt = function (attributeName, value) {
  for (let i = 0; i < this.length; i++) {
